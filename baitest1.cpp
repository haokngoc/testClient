...
int main() {
    ...
    CMD_PACKET packet1;
    initializePacket(packet1, 0xAA, 0x3b, 0x2b, 0x55, 0x55);

    CMD_PACKET packet2;
    initializePacket(packet2, 0xAA, 0x3b, 0x2b, 0x55, 0x55);

    CMD_PACKET packet3;
    initializePacket(packet3, 0xAA, 0x5b, 0x2b, 0x55, 0x55);

    CMD_PACKET packet4;
    initializePacket(packet4, 0xAA, 0x3b, 0x2b, 0x55, 0x55);
    ...
    std::remove(output_file2);
    receiveAndProcessData(client_socket, output_file2);
